...
\noindent\adjustbox{tabular=c}
\bgroup}{\egroup}


\newenvironment{ehabstack}{%
\noindent\adjustbox{stack=cc}%, margin*=0pt 1ex 0pt 0pt}
\bgroup}{\egroup}

\newenvironment{ehabstackb}{%
\noindent\adjustbox{stack=cb}%, margin*=0pt 1ex 0pt 0pt}
\bgroup}{\egroup}
...
\descitem{Ua001!text!a001E!ehexclamtextehexclam!V}{TextMode}{To display non-glyph text inline in a glyph stream in font \mmi{ehtranslitfont}, initially Noto Serif, small, use exclamation mark \mmi{!} as delimiter. The environment is \mmc{ehtranslit}.}
