...
%%%%%\begin{center}
%%%%%\footnotesize
%%%%%\textit{laulu}kaskas \textsc{Series 002}
%%%%%\end{center}
%%%%%\vspace{2em}
%%%%%	
%%%%%%\underliner{User-definable font changer and general method user-definable transliterator for multiple Unicode scripts in a document}
%%%%%\begin{center}
%%%%%\footnotesize
%%%%%v1.0, 20220412
%%%%%\end{center}
...
%%%%%\par\mmc{ftext}: \ftext{𓀀abc αβγδабвгд աა🥣🦊  स्कूल 𐎝𐎜}
%%%%%\item General ability to define one or more transliteration scheme(s), for example \textsc{ascii} input to Lycian output; and integrated with, or separate from, the font-changer.
%%%%%\par \mmc{trtext}: \mm*{{\nsl\trtext[lyc]{lyctran}{aeb}}}
%%%%%\par \mmc{ftrtext}: \mm*{\ftrtext[lyc][lyc]{lyctran}{aeb}}
%%%%%\end{itemize}
%%%%%
%%%%%\bigskip
%%%%%\bigskip
...
%%
%%
%%\underliner{Demonstration}
%%
%%
%%\mfsloadaseq[demo1]{list2digits}{
%%32;47;Punct
%%,48;57;Digits
%%,58;64;Punct
%%,65;90;ucase
...
%%,97;99;lcase
%%}
%%\mfsloadaseq[demo1]{list3digits}{
%%100;122;lcase
%%,123;127;Punct
%%}
%%\mfsloadaseq[demo1]{list4digits}{
%%8216;8223;quotes
%%}
%%
%%\mfsloadaprop[demo1]{block2blockset}{
%%Punct=punctuation
%%,Digits=digits
%%,ucase=uppercase
%%,lcase=lowercase
...
%%}
%%
%%\mfsloadaprop[demo1]{blockset2font}{
%%punctuation=Noto Sans
%%,digits=Noto Sans Mono
%%,uppercase=Noto Serif
%%,lowercase=Noto Serif
%%,quotes=Noto Serif
%%}
%%
%%\mfsloadaprop[demo1]{blockset2fontoptions}{
%%punctuation=Colour;red
%%,digits=Scale;0.9
%%%,uppercase=
%%,lowercase=Scale;1.3
%%,quotes=Colour;blue
%%}
%%
%%\mfsloadaseq[demo1]{demo1tran}{
%%``;8220 % ldq “
%%,'';8221 % rdq ”
%%}
%%
%%Without fontscheme:
%%\ftext{123 The ``cat'', sat on the mat. 456}
%%
%%
%%With fontscheme:
%%\ftext[demo1]{123 The ``cat'', sat on the mat. 456}
%%
%%With quotes translit:
%%\ftrtext[demo1][demo1]{demo1tran}{123 The ``cat'', sat on the mat. 456}
%
%
%\bigskip
%\ns
%\umethod{U+201C U+0063             U+0061U+0074U+201D}{U+2018U+0064U+006FU+0067U+2019}
%
%\count255=`\ꀐ
%\the\count255
%
...
%\ftext[ancient]{abc \trtext[ancient]{lyctran}{aeb} xyz}
%x
%
%{\nsl 𐊀𐊁𐊂 \trtext[ancient]{lyctran}{aebmn} }
%
%|\printtrscheme[ancient][ancient]{lyctran}{lycian}|
%
%\ftext[ancient]{abc𐊀𐊁𐊂 \trtext[ancient]{lyctran}{aebmn}}


%\ftext[ancient]{abc𐊀𐊁𐊂 }%\exp_args:Nx\exp:w\trtext{ancient}{lyctran}{aebmn}\exp_end:}
\section{Sample}
>>\begin{multicols}{2}
\noindent Anatolian: \trftext[ancient]{anatran}{a530a001a002a003a004a005a006}
\par\noindent Avestan: \trftext*[ancient]{avetran}{akexe tethe}
\par\noindent Carian: \trftext[ancient]{cartran}{ap2duuu ldba2q}
\par\noindent \ftrtext[red][ancient]{cartran}{ap2duuu ldba2q}
\par\noindent Cypriot: \trftext[ancient]{cyptran}{aeiou} 
\par\noindent Egyptian Hieroglyphs: \trftext[ancient]{egytran}{a001e026m012h} 
\par\noindent Linear A: \trftext[ancient]{linatran}{ab001a100-102a406-vasa708k} 
\par\noindent Linear B: \trftext[ancient]{linbtran}{wateraVESSEL B305B125} 
\par\noindent Lycian: \trftext[ancient]{lyctran}{aebmn} 
\par\noindent Lydian: \trftext*[ancient]{lydtran}{abgdmark}
\par\noindent Mandaic: \trftext*[ancient]{mantran}{bgdaffatt x?it.}
\par\noindent Meroitic Cursive: \trftext*[ancient]{merctran}{aekha 123 312}
\par\noindent Meroitic Hieroglyphs: \trftextm*[ancient]{merhtran}{ayawabana-2 vidjqata}
\par\noindent Ogham: \trftext[ancient]{oghtran}{blfsp feng}
\par\noindent Old Italic: \trftext[ancient]{oittran}{abc kh10}
\par\noindent Old Persian: \trftext[ancient]{opetran}{kakugathadiv10ssadiv}
\par\noindent Old South Arabian: \trftext*[ancient]{osatran}{hlkhshthghaq}
\par\noindent Old Turkic: \trftext*[ancient]{otutran}{yayiye}
\par\noindent Phaistos Disc: \trftext[ancient]{phatran}{flutelilyobliquevine}
\par\noindent Phoenician: \trftext*[ancient]{photran}{abgd}
\par\noindent Samaritan: \trftext*[ancient]{samtran}{alafbitogamansukun kaafeelabataaa-mimdageshnunep}
\par\noindent Syriac: \trftext*[ancient]{syrtran}{abgklmn}
\par\noindent Ugaritic: \trftext[ancient]{ugatran}{alpa
beta
gamla
}\par\noindent
\end{multicols}
...
\mm*{\trftext[ancient]{anatran}{a530a001a002}}

\mm*{\trftext*[ancient]{anatran}{a530a001a002}}

\mm*{\trftextm[ancient]{anatran}{a530a001a002}}

\mm*{\trftextm*[ancient]{anatran}{a530a001a002}}


\bigskip
\mm*{\trftextm[ancient]{ugatran}{alpabetagamla}}

\mm*{\trftextm[ancient]{uga2tran}{abg}}


\bigskip
\mm*{\ftext{ABC abc αβγδε абвгԘ}}

\mm*{\ftext*{ABC abc αβγδε абвгԘ}}

\mm*{\ftextm{ABC abc αβγδε абвгԘ}}

\mm*{\ftextm*{ABC abc αβγδε абвгԘ}}

\ftext{Þ}\textsuperscript{e}

%\ftext{Ƿ}\textsuperscript{e}

\bigskip
\mm*{{\nsl\trtext[ancient]{lyctran}{aeb}}}

\mm*{{\nsl\trtext*[ancient]{lyctran}{aeb}}}

\mm*{\ftrtext[ancient][ancient]{lyctran}{aeb}}

\mm*{\ftrtext*[ancient][ancient]{lyctran}{aeb}}

\mm*{\ftrtext*[red][ancient]{lyctran}{aeb}}

\mm*{\ftrtext[serif][ancient]{lyctran}{aeb}}


\section{Reference}
\subsection{Anatolian}|\printtrscheme[ancient][ancient]{anatran}{anatolian}[5]|
\subsection{Avestan}|\printtrscheme[ancient][ancient]{avetran}{avestan}|
\subsection{Carian}|\printtrscheme[ancient][ancient]{cartran}{carian}|
\subsection{Cypriot Syllabary}|\printtrscheme[ancient][ancient]{cyptran}{cypriotsyllabary}|
\subsection{Egyptian Hieroglyphs}|\printtrscheme[ancient][ancient]{egytran}{egyptianhieroglyphs}[5]|
\subsection{Linear A}|\printtrscheme[ancient][ancient]{linatran}{lineara}[5]|
\subsection{Linear B}|\printtrscheme[ancient][ancient]{linbtran}{linearb}[5]|
\subsection{Lycian}|\printtrscheme[ancient][ancient]{lyctran}{lycian}|
\subsection{Lydian}|\printtrscheme[ancient][ancient]{lydtran}{lydian}|
\subsection{Mandaic}|\printtrscheme[ancient][ancient]{mantran}{mandaic}|
\subsection{Meroitic Cursive}|\printtrscheme[ancient][ancient]{merctran}{meroiticc}[5]|
\subsection{Meroitic Hieroglyphs}|\printtrscheme[ancient][ancient]{merhtran}{meroitich}|
\subsection{Ogham}|\printtrscheme[ancient][ancient]{oghtran}{ogham}|
\subsection{Old Italic}|\printtrscheme[ancient][ancient]{oittran}{olditalic}|
\subsection{Old Persian}|\printtrscheme[ancient][ancient]{opetran}{oldpersian}|
\subsection{Old South Arabian}|\printtrscheme[ancient][ancient]{osatran}{oldsoutharabian}|
\subsection{Old Turkic}|\printtrscheme[ancient][ancient]{otutran}{oldturkic}|
\subsection{Phaistos Disc}|\printtrscheme[ancient][ancient]{phatran}{phaistosdisc}[4]|
\subsection{Phoenician}|\printtrscheme[ancient][ancient]{photran}{phoenician}|
\subsection{Samaritan}|\printtrscheme[ancient][ancient]{samtran}{samaritan}[4]|
\subsection{Syriac}|\printtrscheme[ancient][ancient]{syrtran}{syriac}|
\subsection{Ugaritic}|\printtrscheme[ancient][ancient]{ugatran}{ugaritic}[5]|
\subsection{Ugaritic (2)}|\printtrscheme[ancient][ancient]{uga2tran}{ugaritic}|

%%\printitemref[ancient]{anatran}{a110}
